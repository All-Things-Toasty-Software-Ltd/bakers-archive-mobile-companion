...
class OdooService(
    ...
    private val archives = listOf(
        Archive(
            name = "The Sourdough Archives", url = "$baseUrl/archive/the-sourdough-archives-1/feed"
        ), Archive(
            name = "Secondary Archive", url = "$baseUrl/archive/secondary-archive-2/feed"
        )
    )
    ...
    private suspend fun getArchiveRecipes(
        archive: Archive
    ): List<ArchiveRecipe> {
